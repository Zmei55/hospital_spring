...
public interface LaboratoriesApi {
    ...
    @GetMapping("/{labor-id}")
    ResponseEntity<ResponseDto> getById(@PathVariable("labor-id") Long patientId);
    ...
    ResponseEntity<ResponseDto> updateById(
        @PathVariable("labor-id") Long patientId,
    ...
    void deleteById(@PathVariable("labor-id") Long patientId);
}
